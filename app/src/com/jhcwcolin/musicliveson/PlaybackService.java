...
public class PlaybackService extends Service {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.jhcwcolin.musicliveson.PLAY_PAUSE";
    public static final String ACTION_NEXT = "com.jhcwcolin.musicliveson.NEXT";
    public static final String ACTION_PREV = "com.jhcwcolin.musicliveson.PREV";
    public static final String ACTION_STOP = "com.jhcwcolin.musicliveson.STOP";
    ...
    private void acquireWakelock() {
        if (wakelock == null) {
            ...
            if (pm != null) {
                wakelock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "musicliveson:playback");
            }
        }
